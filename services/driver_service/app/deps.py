...
from .services import get_driver, get_driver_link
...
def rbac_check(permission: str):
    ...
    def checker(request: Request, role: str = Depends(get_current_role)):
        ...
        permissions = {
            "driver:create": ["Owner", "Admin", "Editor"],
            "driver:read": ["Owner", "Admin", "Editor", "Viewer"],
            "driver:update": ["Owner", "Admin", "Editor"],
            "driver:delete": ["Owner", "Admin"],
            "driver_link:create": ["Owner", "Admin", "Editor"],
            "driver_link:read": ["Owner", "Admin", "Editor", "Viewer"],
            "driver_link:update": ["Owner", "Admin", "Editor"],
            "driver_link:delete": ["Owner", "Admin"],
            "influence:read": ["Owner", "Admin", "Editor", "Viewer"],
