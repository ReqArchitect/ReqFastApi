...
app = FastAPI(
    ...
    description="Microservice for managing ArchiMate 3.2 Requirement elements",
    version="1.0.0"
)
...
REQUESTS_TOTAL = Counter(
    "requirement_service_requests_total",
    "Total requests",
    ["method", "route", "status"]
)
REQUEST_LATENCY = Histogram(
    "requirement_service_request_latency_seconds_bucket",
    "Request latency",
    ["method", "route"]
)
ERRORS_TOTAL = Counter(
    "requirement_service_errors_total",
    "Total errors",
    ["method", "route"]
)
...
tracer = trace.get_tracer("requirement_service")
