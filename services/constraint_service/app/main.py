...
app = FastAPI(
    ...
    description="Microservice for managing ArchiMate 3.2 Constraint elements",
    version="1.0.0"
)
...
logger = logging.getLogger("constraint_service")
logger.setLevel(logging.INFO)
logger.handlers = [handler]

# Prometheus metrics
REQUESTS_TOTAL = Counter(
    "constraint_service_requests_total",
    "Total requests",
    ["method", "route", "status"]
)
REQUEST_LATENCY = Histogram(
    "constraint_service_request_latency_seconds_bucket",
    "Request latency",
    ["method", "route"]
)
ERRORS_TOTAL = Counter(
    "constraint_service_errors_total",
    "Total errors",
    ["method", "route"]
)
...
tracer = trace.get_tracer("constraint_service")
