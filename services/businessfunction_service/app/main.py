...
app = FastAPI(
    title="Business Function Service",
    description="Microservice for managing ArchiMate 3.2 Business Function elements",
    version="1.0.0"
)
...
logger = logging.getLogger("business_function_service")
...
tracer = trace.get_tracer("business_function_service")
