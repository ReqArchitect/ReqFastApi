...
from .services import get_resource, get_resource_link
...
def rbac_check(permission: str):
    ...
    def checker(request: Request, role: str = Depends(get_current_role)):
        ...
        permissions = {
            "resource:create": ["Owner", "Admin", "Editor"],
            "resource:read": ["Owner", "Admin", "Editor", "Viewer"],
            "resource:update": ["Owner", "Admin", "Editor"],
            "resource:delete": ["Owner", "Admin"],
            "resource_link:create": ["Owner", "Admin", "Editor"],
            "resource_link:read": ["Owner", "Admin", "Editor", "Viewer"],
            "resource_link:update": ["Owner", "Admin", "Editor"],
            "resource_link:delete": ["Owner", "Admin"],
            "impact:read": ["Owner", "Admin", "Editor", "Viewer"],
            "analysis:read": ["Owner", "Admin", "Editor", "Viewer"],
            "allocation:read": ["Owner", "Admin", "Editor", "Viewer"]
        }
