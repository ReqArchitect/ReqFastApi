...
app = FastAPI(
    title="Application Function Service",
    description="Microservice for managing ArchiMate 3.2 Application Function elements",
    version="1.0.0"
)
...
logger = logging.getLogger("application_function_service")
...
tracer = trace.get_tracer("application_function_service")
