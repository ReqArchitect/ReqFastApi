...
app = FastAPI(
    ...
    description="Microservice for managing ArchiMate 3.2 Driver elements",
    version="1.0.0"
)
...
REQUEST_LATENCY = Histogram(
    "driver_service_request_latency_seconds_bucket",
    "Request latency",
    ["method", "route"]
)
ERRORS_TOTAL = Counter(
    "driver_service_errors_total",
    "Total errors",
    ["method", "route"]
)
...
tracer = trace.get_tracer("driver_service")
